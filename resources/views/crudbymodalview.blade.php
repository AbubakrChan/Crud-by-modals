    ...
    <table >
            ...
            <tr>
                ...
                <td>
                    ...
                    <form  method="POST" id="abcd{{$daata['id']}}" class="idbu">
                        @csrf
                        <button type="button" value="delete"  id="delete" name="delete"  onclick="confirmDeleteModal({{$daata['id']}})" >Delete</button>
                ...
                <td>
                    ...
                    <form  method="POST" id="abcde{{$daata['id']}}" >
                        @csrf
                    <button type="button"  data-toggle="modal"   data-target="#myModal{{$daata->id}}">Edit</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form  method="post" >
                                @csrf
                                <h3>Username.</h3>
                                <input type="text" id="name1" name="name"  value="{{$daata->name}}" required><br>
                                <h3>Email</h3>
                                <input type="text" id="email1" name="email" value="{{$daata->email}}" required><br><br>
                                <h3>Password</h3>
                                <input type="text" id="password1" name="password"  value="{{$daata->password}}" required><br><br>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <form  method="post" id="abcde">
        ...
        <script type="text/javascript">
            ...
            $('#abcde{{$daata['id']}}').on('click',function(event){
                ...
                $('#abcde').on('submit',function(event){
                    event.preventDefault()
                    id= {{$daata->id}};
                    name = $('#name1').val();
                    email = $('#email1').val();
